...
namespace Fintrak.Business.IFRS.Managers
{
    ...
    public class IFRSLoanManager : ManagerBase, IIFRSLoanService
    {
        ...
        public CollateralInformation[] GetAvailableCollateralInformation(int defaultCount, string path)
        {
            return ExecuteFaultHandledOperation(() =>
            {
                var groupNames = new List<string>() { GROUP_ADMINISTRATOR, GROUP_USER };
                ...
                IEnumerable<CollateralInformation> availableCollateralInformation = CollateralInformationRepository.GetAvailableCollateralInformation(defaultCount, path);
                return availableCollateralInformation.ToArray();
